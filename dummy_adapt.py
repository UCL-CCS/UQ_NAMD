...
campaign = uq.Campaign(state_file="./states/namd_easyvvuq_state.{}.json".format(iteration),
                       work_dir=work_dir)
print('========================================================')
print('Reloaded campaign', campaign.campaign_dir.split('/')[-1], ' at iteration: ', iteration)
print('========================================================')
sampler = campaign.get_active_sampler()
sampler.load_state("./states/namd_sampler_state.{}.pickle".format(iteration))
campaign.set_sampler(sampler)
analysis = uq.analysis.SCAnalysis(sampler=sampler, qoi_cols=output_columns)
analysis.load_state("./states/namd_analysis_state.{}.pickle".format(iteration))
