...
import json
import numpy as np
from utils import SimEncoder, Eq0Encoder, Eq1Encoder, Eq2Encoder

#EDIT: adaptive campaigns have only 1 QoI
...
#   "minimize_eq0": cp.DiscreteUniform(1000*0.85,1000*1.15),
#   "initTemperature_eq1": cp.Uniform(50.0*0.85,50.0*1.15),
#   "reassignFreq_eq1": cp.DiscreteUniform(100*0.85,100*1.15),
...
vary_solver = {
  ...
  "PMEGridSpacing": cp.Uniform(1.0*0.85,1.0*1.15),
  "minimize_eq0": cp.Uniform(1000*0.85,1000*1.15),
  "initTemperature_eq1": cp.Uniform(50.0*0.85,50.0*1.15),
  "reassignFreq_eq1": cp.Uniform(100*0.85,100*1.15),
  "reassignIncr_eq1": cp.Uniform(1.0*0.85,1.0*1.15),
  "langevinDamping": cp.Uniform(5.0*0.85,5.0*1.15),
  # "langevinHydrogen": ["yes", "no"],
  # "useGroupPressure": ["yes", "no"],
...
campaign.save_state("./states/namd_easyvvuq_state.0.json")
sampler.save_state("./states/namd_sampler_state.0.pickle")
